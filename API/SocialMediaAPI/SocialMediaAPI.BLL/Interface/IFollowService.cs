...
namespace SocialMediaAPI.BLL.Interface
{
    public interface IFollowService
    {
        ...
        Task<List<ReturnFollowDto>> SearchFollowedUsersByName(Guid userId, string searchName);
        Task<List<ReturnFollowingIdDto>> GetAllFollowings(Guid userId);
        Task<Boolean> CheckExistingFollow(Guid authUserId, Guid followerId, Guid followingId);
